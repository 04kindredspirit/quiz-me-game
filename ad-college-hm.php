...
<html lang="en">
  <head>
    ...
    />
    <link rel="stylesheet" href="ad-college-hm.css" />
    <title>BSHM List</title>
  </head>
  <body>
    <div class="wrapper">
      <aside id="sidebar">
            ...
            <div class="mb-3">
              ...
              <div class="row">
                <div class="col-lg-9 col-md-6">
                  <h3 class="fw-bold fs-4 my-2">List of BSHM Students</h3>
                </div>
    ...
    if(isset($_GET['search'])) {
        ...
        $query = "SELECT * FROM bshm WHERE ID LIKE '%$search%' OR CONCAT(FirstName, ' ', MiddleName, ' ', LastName) LIKE '%$search%'";
    }
