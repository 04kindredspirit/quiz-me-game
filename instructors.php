          ...
          <div class="container-fluid">
            ...
            <div class="container bg-white rounded p-3">
              <div class="row px-3">
                ...
                <form form action="updateinstructors.php" method="post" enctype="multipart/form-data" class="row gy-2 gx-3 align-items-center">
                  <div class="col-auto">
                    <select class="form-select" name="ins_id" id="autoSizingSelect">
                ...
                <div class="row g-3 needs-validation my-3" novalidate>
                  ...
                  <div class="col-lg-10 col-md-12">
                    <label for="validationCustom01" class="form-label"
                      >Instructor's Description</label
                    >
                    <textarea name="ins_description" id="default" ></textarea>
                  </div>
                  <div class="col-lg-6 col-md-12">
                    <div class="mb-3">
