...
<html lang="en">
  ...
  <body>
        ...
        <main class="content px-3 py-4">
          <div class="container-fluid">
            ...
            <div class="container bg-white rounded p-3">
              ...
              <form action="updatenewssection.php" method="post" enctype="multipart/form-data" class="row gy-2 gx-3 align-items-center">
    <div class="col-auto">
        <select class="form-select" name="news_id">
            <option selected>Choose News...</option>
            <?php
            // Assuming $conn is your database connection
            $sql = "SELECT ID, Title FROM newssection";
    ...
    <div class="col-lg-10 col-md-12">
        ...
        <textarea name="news_description" id="default"></textarea>
    </div>
    <div class="col-lg-6 col-md-12">
        <div class="mb-3">
