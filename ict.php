  ...
  <body>
    ...
    <div class="container mt-3">
      <div class="row">
        ...
        <hr />
        <p>
          "ICT: Innovating Connections, Transforming Technology for Tomorrow."
        </p>
      </div>
    </div>
      ...
      <div class="row g-0">
        ...
        <div class="col-md-6">
          <p>
            ...
            is a broad and rapidly evolving field that encompasses the
            convergence of telecommunications, computing, and information
            systems. In today’s digital age, ICT plays a pivotal role in shaping
            the way individuals, businesses, and societies communicate,
            collaborate, and access information. ICT professionals are
            responsible for designing, implementing, and managing a wide range
            of technologies, including computer networks, software applications,
            telecommunications systems, and digital platforms.
          </p>
          <p>
            is a broad and rapidly evolving field that encompasses the
            convergence of telecommunications, computing, and information
