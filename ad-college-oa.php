...
<html lang="en">
  <head>
    ...
    />
    <link rel="stylesheet" href="ad-college-oa.css" />
    <title>BSOA List</title>
  </head>
  <body>
    <div class="wrapper">
      <aside id="sidebar">
            ...
            <div class="mb-3">
              ...
              <div class="row">
                <div class="col-lg-9 col-md-6">
                  <h3 class="fw-bold fs-4 my-2">List of BSOA Students</h3>
                </div>
              ...
              <div class="row mt-4">
                <div class="col-lg-12 mt-2">
                  <table class="table table-striped">
                    <thead>
                      <tr class="highlight fs-6" style="overflow: auto" id="style-1">
                      <th scope="col">ID</th>
    ...
    if(isset($_GET['search'])) {
        ...
        $query = "SELECT * FROM bsoa WHERE ID LIKE '%$search%' OR CONCAT(FirstName, ' ', MiddleName, ' ', LastName) LIKE '%$search%'";
    }
