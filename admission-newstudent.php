...
<html lang="en">
  <head>
    ...
    />
    <link rel="stylesheet" href="admission-newstudent.css" />
  ...
  <body>
    ...
    <div class="card">
      <img src="images/reg-new1.jpg" alt="..." />
    </div>

    <div class="container">
      <div class="row">
        <div class="col-md-12 my-3">
          <h1 class="ad-title">Online Reservation Form for New Students</h1>
          <hr />
          <p>
      ...
      <form class="row g-3 needs-validation" novalidate>
        ...
        <div class="col-md-12">
          <label for="validationDefault02" class="form-label"
            >Select Program<span class="text-danger"> *</span></label
          >
          <div class="row ms-3">
        ...
        <div class="col-md-12" id="collegediv">
          <!-- college courses -->
          <label for="collegeCourseSelect" class="form-label"
            >Select Course<span class="text-danger"> *</span></label
          >
        ...
        <div class="col-md-12" id="shsdiv" style="display: none">
          <!-- shs strands -->
          <label for="shsStrandSelect" class="form-label"
            >Select Strand<span class="text-danger"> *</span></label
          >
        ...
        <div class="container bg-info-subtle mt-3">
          <p class="ad-title fw-bold fs-4 pt-3 ps-3">Educational Background</p>
        </div>
        <div class="col-md-12">
          <label for="validationCustom01" class="form-label"
            >High School Name<span class="text-danger"> *</span></label
          >
          <input
            type="text"
            class="form-control"
        ...
        <div class="col-md-12">
          <label for="validationCustom02" class="form-label"
            >High School Address<span class="text-danger"> *</span></label
          >
          <input
            type="text"
            class="form-control"
        ...
        <div class="container bg-info-subtle mt-3">
          <p class="ad-title fw-bold fs-4 pt-3 ps-3">Guardian Information</p>
        </div>
        <div class="col-md-6">
          <label for="validationCustom01" class="form-label"
            >Name of Mother (Full Name)<span class="text-danger">
              *</span
            ></label
          >
          <input
        ...
        <div class="col-md-6">
          ...
          <input
            ...
            class="form-control"
            id="validationCustom02"
            placeholder="N/A if you prefer not to fill in the blank"
            required
          />
          <div class="valid-feedback">Looks good!</div>
        </div>
        ...
        <div class="col-md-6">
          <label for="validationCustom01" class="form-label"
            >Name of Father (Full Name)<span class="text-danger">
              *</span
            ></label
          >
          <input
        ...
        <div class="col-md-6">
          <label for="validationCustom01" class="form-label"
            >Guardian (Full Name)<span class="text-danger"> *</span></label
          >
          <input
            type="text"
            class="form-control"
  ...
  <script>
    ...
    function enableDisableDiv(val) {
      if (val == 1) {
        ...
        document.getElementById("shsdiv").style.display = "none";
      }
      if (val == 2) {
        document.getElementById("collegediv").style.display = "none";
        document.getElementById("shsdiv").style.display = "block";
      }
    }
  </script>
</html>
