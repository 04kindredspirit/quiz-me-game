...
<html lang="en">
  <head>
    ...
    />
    <link rel="stylesheet" href="ad-ict.css" />
  ...
  <body>
            ...
            <div class="mb-3">
              ...
              <div class="row">
                <div class="col-lg-9 col-md-6">
                  <h3 class="fw-bold fs-4 my-2">List of ICT Students</h3>
                </div>
    ...
    if(isset($_GET['search'])) {
        ...
        $query = "SELECT * FROM ict WHERE ID LIKE '%$search%' OR CONCAT(FirstName, ' ', MiddleName, ' ', LastName) LIKE '%$search%'";
    }
