        ...
        <main class="content px-3 py-4">
          <div class="container-fluid">
            ...
            <div class="container bg-white rounded p-3">
              <h3 class="text-center fs-6 fw-bold">Update Profile Settings</h3>
              <?php
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            
            echo '<div class="text-center my-5">';
            echo '<img src="images/' . $row["img"] . '"  class="rounded img-fluid" style="height: 200px; width: 200px;" alt="Profile Image">';
            echo '</div>';
                ...
                <form action="update_profile.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="input-container" style="width: 70%;">
                            <div class="row g-3 d-flex">
                                <div class="col-md-12 col-sm-12">
                                    <input type="text" class="form-control" name="username" placeholder="New Name" aria-label="New Name">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="container d-flex justify-content-center mb-3">
                        <div class="input-container" style="width: 70%;">
                            <div class="row g-3 d-flex">
                                <div class="col">
                                    <input type="password" class="form-control" name="password" placeholder="Leave blank to retain old password" aria-label="New Password">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="container d-flex justify-content-center mb-3">
                        <div class="input-container" style="width: 70%;">
                            <div class="row">
                                <div class="mb-3">
                                    <label for="formFile" class="form-label">Choose File Image</label>
