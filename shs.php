...
<html lang="en">
  ...
  <body>
    ...
    <!-- hero or img section -->
    <div class="card">
      <img src="images/shs-page1.jpg" alt="..." />
    </div>

    <!-- courses section -->
    <div class="container mt-3">
      <div class="row">
        <h1>Senior High School Courses</h1>
        <hr />
        <p>
          "Charting Your Path to Success: Senior High School - Where Dreams Take
          Flight."
        </p>
      </div>
    </div>
    ...
    <div class="container mb-3">
      <div class="row">
        <div class="col-md-12">
          <div class="header">
            <h6 class="bg-primary-subtle m-0 p-3 rounded-top">SHS Strands</h6>
          </div>
          <div class="course p-3 border border-top-0">
            <a href="ict.php" class="text-decoration-none"
              ><i class="bi bi-box-arrow-in-right me-2"></i>Information and
              Communication Technology (ICT)
            </a>
          </div>
          <div class="course p-3 border border-top-0">
            <a href="he.php" class="text-decoration-none"
              ><i class="bi bi-box-arrow-in-right me-2"></i>Home Economics (HE)
            </a>
          </div>
          <div class="course p-3 border border-top-0">
            <a href="stem.php" class="text-decoration-none"
              ><i class="bi bi-box-arrow-in-right me-2"></i>Science, Technology,
              Engineering, and Mathematics (STEM)
            </a>
          </div>
          <div class="course p-3 border border-top-0">
            <a href="humss.php" class="text-decoration-none"
              ><i class="bi bi-box-arrow-in-right me-2"></i>Humanities and
              Social Sciences (HUMSS)
            </a>
          </div>
          <div class="course p-3 border border-top-0">
            <a href="gas.php" class="text-decoration-none"
              ><i class="bi bi-box-arrow-in-right me-2"></i>General Academic
              Strand (GAS)
            </a>
          </div>
          <div class="course p-3 border border-top-0">
            <a href="abm.php" class="text-decoration-none"
              ><i class="bi bi-box-arrow-in-right me-2"></i>Accountancy,
