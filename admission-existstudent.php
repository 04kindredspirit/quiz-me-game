...
<html lang="en">
  <head>
    ...
    />
    <link rel="stylesheet" href="admission-existstudent.css" />
  ...
  <body>
    ...
    <div class="card">
      <img src="images/reg-existing1.jpg" alt="..." />
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 my-3">
          <h1 class="ad-title">
            Online Registration Form for Existing Students
          </h1>
          <hr />
          <p>
      ...
      <form class="row g-3 needs-validation" novalidate>
        ...
        <div class="col-md-6">
          <label for="validationCustom02" class="form-label"
            >Current Year<span class="text-danger"> *</span></label
          >
          <select class="form-select" id="collegeCourseSelect" required>
